...
MIT License. See [LICENSE](https://github.com/coder0name0dre/simple_port_scanner/blob/main/LICENSE) for details - feel free to re-use and modify, but do not use it for unauthorized scanning.
